 ...
 * flags all string literals in the code that contain the word "book".
 */
...
class SampleCodeDetector : Detector(), UastScanner {
            ...
            override fun visitLiteralExpression(node: ULiteralExpression) {
                ...
                if (string.contains("book")) {
                    context.report(
                        ...
                        "This code mentions `book`: **Congratulations**"
                    )
                }
            }
        }
    ...
    companion object {
        ...
        val ISSUE: Issue = Issue.create(
            ...
            explanation = """
                    This check highlights string literals in code which mentions the word `book`. \
                    Blah blah blah.
